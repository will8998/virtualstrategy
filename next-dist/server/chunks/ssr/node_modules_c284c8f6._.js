...
`;var cg=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let ch=class extends ce.LitElement{constructor(){super(...arguments),this.prevQuery="",this.prevBadge=void 0,this.loading=!0,this.query=""}render(){return this.onSearch(),this.loading?c.html`<wui-loading-spinner color="accent-100"></wui-loading-spinner>`:this.walletsTemplate()}async onSearch(){(this.query.trim()!==this.prevQuery.trim()||this.badge!==this.prevBadge)&&(this.prevQuery=this.query,this.prevBadge=this.badge,this.loading=!0,await e.ApiController.searchWallet({search:this.query,badge:this.badge}),this.loading=!1)}walletsTemplate(){let{search:a}=e.ApiController.state,b=ac.WalletUtil.markWalletsAsInstalled(a);return a.length?c.html`
    ...
    `}onInputChange(a){this.onDebouncedSearch(a.detail)}onClick(){if("certified"===this.badge){this.badge=void 0;return}this.badge="certified",ar.SnackController.showSvg("Only WalletConnect certified",{icon:"walletConnectBrown",iconColor:"accent-100"})}qrButtonTemplate(){return f.CoreHelperUtil.isMobile()?c.html`
        ...
        ></wui-icon-box>
      `:null}onWalletConnectQr(){o.RouterController.push("ConnectingWalletConnect")}};ci([(0,d.state)()],cj.prototype,"search",void 0),ci([(0,d.state)()],cj.prototype,"badge",void 0),cj=ci([(0,i.customElement)("w3m-all-wallets-view")],cj),a.s(["W3mDownloadsView",()=>cp],638292);var ck=b,cl=b;let cm=t.css`
  button {
    column-gap: var(--wui-spacing-s);
